...
```javascript
names = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/datasets-us-states-names@umd/bundle.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/datasets-us-states-names@umd/bundle.js"></script>
```
